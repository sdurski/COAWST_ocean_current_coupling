...
export   COAWST_APPLICATION=CCS8_SUVN
...
export   MY_ROOT_DIR=/nobackup/sdurski/COAWST_ocean_current_coupling
export   MY_PROJECT_DIR=${MY_ROOT_DIR}/Projects/CCS
